...
Moobile.Component.defineStyle('locaface', Moobile.Bar, {
    attach: function(element) { element.addClass('style-locaface'); },
    detach: function(element) { element.removeClass('style-locaface'); }
});
...
Moobile.ListItem = new Class({
	...
	willBuild: function() {
        ...
        var button = this.getRoleElement('button');
    ...
    setButton: function(button) {
       ...
       // button = Moobile.Button.from(button);

        if (this._button) {
            this._button.replaceWithComponent(button, true);
        } else {
            this.addChildComponent(button);
        }

        this._button= button;
        this._button.addClass('list-item-button');
        //this.toggleClass('list-item-button-empty', this._button.isEmpty());
...
Moobile.Component.defineRole('button', Moobile.ListItem, null, function(element) {
    this.setDetail(Moobile.Component.create(Moobile.Button, element, 'data-button'));
});
// <0.1-compat>
/**
 * @deprecated
